      ...
      <main>
        <section className="page-gutter grid min-h-167.5 items-center gap-12 py-16 lg:grid-cols-[1.05fr_.95fr] lg:py-24">
          ...
          <div className="relative mx-auto aspect-square w-full max-w-140">
            ...
            <div className="absolute left-[2%] top-[1%] h-[42%] w-[42%] overflow-hidden rounded-full border-12 border-white"><Image src="/images/sonrisa.jpg" alt="Sonrisa saludable" fill className="object-cover" priority sizes="240px" /></div>
            <div className="absolute right-0 top-[18%] h-[57%] w-[57%] overflow-hidden rounded-full border-12 border-white"><Image src="/images/paciente-feliz.jpg" alt="Paciente satisfecha en consulta" fill className="object-cover" priority sizes="330px" /></div>
            <div className="absolute bottom-[2%] left-[8%] h-[38%] w-[38%] overflow-hidden rounded-[50%_50%_18%_50%] border-12 border-white"><Image src="/images/tratamiento-dental.jpg" alt="Atención odontológica" fill className="object-cover" sizes="220px" /></div>
          </div>
        </section>
